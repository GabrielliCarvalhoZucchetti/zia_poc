...
const HomePage: React.FC = () => {
  ...
  return (
    <div className="flex-1 overflow-y-auto bg-[#f8fafc] p-8 relative">
      <div className="max-w-[1550px] mx-auto space-y-8 pb-12">
        ...
        <header className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <button 
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white hover:bg-slate-50 text-sky-600 rounded-xl text-xs font-bold transition-all shadow-sm border border-slate-200 cursor-pointer"
          >
        ...
        <div className="bg-white rounded-3xl border border-slate-100 p-6 flex flex-col lg:flex-row items-center justify-between gap-6 shadow-sm">
          <div className="flex items-center gap-5 w-full lg:w-auto">
            <div className="relative">
              <img 
                src="https://picsum.photos/seed/joaosilva/150/150" 
                alt="Joao Silva" 
                className="w-20 h-20 rounded-2xl object-cover border border-slate-200 shadow-inner"
              />
              <div className="absolute -bottom-1.5 -right-1.5 bg-blue-500 text-white rounded-full p-1 border-2 border-white shadow-sm flex items-center justify-center">
          ...
          <div className="flex flex-wrap items-center gap-4 w-full lg:w-auto">
            <div className="flex-1 lg:flex-none min-w-[140px] bg-slate-50 border border-slate-100 rounded-2xl p-4 text-left">
              <div className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Interações Luna</div>
              <div className="text-2xl font-black text-slate-800 mt-1">15</div>
            </div>
            
            <div className="flex-1 lg:flex-none min-w-[140px] bg-slate-50 border border-slate-100 rounded-2xl p-4 text-left">
              <div className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Recursos Criados</div>
              <div className="text-2xl font-black text-slate-800 mt-1">2</div>
            </div>
            
            <div className="flex-1 lg:flex-none min-w-[140px] bg-slate-50 border border-slate-100 rounded-2xl p-4 text-left">
              <div className="text-[9px] font-bold text-slate-400 uppercase tracking-wider">Em Produção</div>
              <div className="text-2xl font-black text-slate-800 mt-1">1</div>
            </div>
          </div>
        </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-base font-black text-slate-800 tracking-tight">Próximas Missões</h3>
            </div>
            <div className="flex items-center gap-1.5">
              <button className="p-1.5 rounded-lg bg-white border border-slate-200 text-slate-400 hover:text-slate-600 cursor-not-allowed" disabled>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            ...
            {/* Mission Card 1 */}
            <div className="bg-emerald-50/20 border border-emerald-100 rounded-[24px] p-6 flex flex-col justify-between space-y-6 relative overflow-hidden transition-all hover:shadow-sm">
              <div className="absolute top-0 right-0 w-16 h-16 bg-emerald-500/10 rounded-bl-[50px] flex items-center justify-center pl-6 pb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest text-emerald-600 bg-emerald-100/50 px-2.5 py-0.5 rounded-md">
                    CONCLUÍDA
                  </span>
                </div>
                <div>
                  <h4 className="text-sm font-black text-slate-850">AI Starter</h4>
            ...
            {/* Mission Card 2 */}
            <div className="bg-white border border-slate-200 rounded-[24px] p-6 flex flex-col justify-between space-y-6 transition-all hover:shadow-sm hover:border-slate-300">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                ...
                <div>
                  <h4 className="text-sm font-black text-slate-850">AI User</h4>
                  <p className="text-[11px] text-slate-500 leading-relaxed mt-2">
            ...
            {/* Mission Card 3 */}
            <div className="bg-slate-50/50 border border-slate-100 rounded-[24px] p-6 flex flex-col justify-between space-y-6 opacity-85">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-600">AI Builder</h4>
            ...
            <div className="bg-slate-50/50 border border-slate-100 rounded-[24px] p-6 flex flex-col justify-between space-y-6 opacity-85">
              <div className="space-y-4">
                ...
                <div>
                  <h4 className="text-sm font-bold text-slate-600">AI Champion</h4>
                  <p className="text-[11px] text-slate-400 leading-relaxed mt-2">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-black text-slate-800 tracking-tight">Ranking</h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
            
            {/* Ranking 2: AI Starter */}
            <div className="bg-white rounded-3xl border border-slate-150 shadow-sm flex flex-col justify-between overflow-hidden">
              <div>
                <div className="p-5 border-b border-slate-100 flex items-center gap-2.5">
                  <div className="w-6 h-6 rounded-lg bg-indigo-50 text-indigo-550 flex items-center justify-center">
                    <Icons.Home className="w-3.5 h-3.5 text-indigo-500" />
                  </div>
                  <span className="text-xs font-bold text-slate-700">Ranking AI Starter</span>
                </div>
                  ...
                  {RANKING_AI_STARTER.map((user, i) => (
                    <div key={i} className="px-5 py-3.5 flex items-center justify-between hover:bg-slate-50/50 transition-colors">
                      <div className="flex items-center gap-3">
                        <span className="text-xs font-extrabold text-slate-400 w-5">{user.rank}</span>
                        <img src={user.avatar} alt={user.name} className="w-8 h-8 rounded-full border border-slate-200" />
                        <span className="text-xs font-bold text-slate-700">{user.name}</span>
                      </div>
                      <div className="text-right">
                        <div className="text-xs font-black text-slate-800">{user.count}</div>
                        <div className="text-[7.5px] font-bold text-slate-400 uppercase tracking-wide">{user.type}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="p-4 border-t border-slate-50 bg-slate-50/40 flex items-center justify-between">
                <button className="text-[10px] text-slate-400 hover:text-slate-600 disabled:opacity-50" disabled>◀</button>
                <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider">Página 1/1</span>
                <button className="text-[10px] text-slate-400 hover:text-slate-600 disabled:opacity-50" disabled>▶</button>
              </div>
            </div>
            ...
            <div className="bg-white rounded-3xl border border-slate-150 shadow-sm flex flex-col justify-between overflow-hidden">
              <div>
                <div className="p-5 border-b border-slate-100 flex items-center gap-2.5">
                  ...
                  <span className="text-xs font-bold text-slate-700">Ranking AI Users</span>
                </div>
            ...
            {/* Ranking 3: AI Builder */}
            <div className="bg-white rounded-3xl border border-slate-150 shadow-sm flex flex-col justify-between overflow-hidden">
              <div>
                <div className="p-5 border-b border-slate-100 flex items-center gap-2.5">
                  <div className="w-6 h-6 rounded-lg bg-teal-50 text-teal-500 flex items-center justify-center">
                    <Icons.AgentBuilder className="w-3.5 h-3.5" />
                  </div>
                  <span className="text-xs font-bold text-slate-700">Ranking AI Builder</span>
                </div>
            ...
            {/* Ranking 4: AI Champion */}
            <div className="bg-white rounded-3xl border border-slate-150 shadow-sm flex flex-col justify-between overflow-hidden">
              <div>
                <div className="p-5 border-b border-slate-100 flex items-center gap-2.5">
                  <div className="w-6 h-6 rounded-lg bg-amber-50 text-amber-500 flex items-center justify-center">
                    <Icons.Sparkle className="w-3.5 h-3.5 text-amber-500" />
                  </div>
                  <span className="text-xs font-bold text-slate-700">Ranking AI Champion</span>
                </div>
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2">
            <span className="text-lg">📢</span>
            <h3 className="text-base font-black text-slate-800 tracking-tight">Luna News</h3>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            
            {/* News 1 */}
            <div className="bg-white border border-slate-200 rounded-3xl p-6 flex flex-col justify-between space-y-4 hover:shadow-md hover:border-slate-300 transition-all">
              <div className="space-y-3">
                <div className="flex items-center justify-between text-[10px] font-black tracking-widest text-slate-400">
                  <span className="bg-indigo-50 text-indigo-600 px-2.5 py-1 rounded-md">INOVAÇÃO</span>
                  <span>2026-04-20</span>
                </div>
                <h4 className="text-base font-black text-slate-800 leading-snug">Novo Modelo GPT-5 Liberado!</h4>
              ...
              <button 
                ...
                className="text-xs text-sky-600 hover:text-sky-700 font-bold flex items-center gap-1 cursor-pointer transition-colors"
              >
                <span>Ler mais</span>
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-6 flex flex-col justify-between space-y-4 hover:shadow-md hover:border-slate-300 transition-all">
              <div className="space-y-3">
                <div className="flex items-center justify-between text-[10px] font-black tracking-widest text-slate-400">
                  <span className="bg-violet-50 text-violet-600 px-2.5 py-1 rounded-md">EDUCAÇÃO</span>
                  <span>2026-04-18</span>
                </div>
                <h4 className="text-base font-black text-slate-800 leading-snug">Workshop de Prompt Engineering</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
            ...
            <div className="bg-white border border-slate-200 rounded-3xl p-6 flex flex-col justify-between space-y-4 hover:shadow-md hover:border-slate-300 transition-all">
              <div className="space-y-3">
                <div className="flex items-center justify-between text-[10px] font-black tracking-widest text-slate-400">
                  <span className="bg-brand-50 bg-sky-50 text-sky-600 px-2.5 py-1 rounded-md">NOVOS RECURSOS</span>
                  <span>2026-04-15</span>
                </div>
                <h4 className="text-base font-black text-slate-800 leading-snug">Luna agora fala com seu ERP</h4>
                <p className="text-xs text-slate-500 leading-relaxed">
      ...
      {selectedNews && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs">
          <div className="w-full max-w-lg bg-white rounded-3xl p-8 border border-slate-100 shadow-2xl relative space-y-6">
            <button 
              type="button" 
              onClick={() => setSelectedNews(null)}
              className="absolute top-6 right-6 p-2 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-400 hover:text-slate-600 cursor-pointer transition-colors"
            >
              <Icons.X className="w-4 h-4" />
            </button>
            <div className="space-y-2">
              <div className="flex items-center justify-between text-[10px] font-black tracking-widest text-slate-400">
                <span className="bg-sky-50 text-sky-600 px-2 rounded-md py-0.5">{selectedNews.tag}</span>
                <span>{selectedNews.date}</span>
              </div>
              <h3 className="text-xl font-black text-slate-800 tracking-tight leading-tight pt-1">
                {selectedNews.title}
              </h3>
            </div>
            ...
            <div className="pt-2">
              <button 
                type="button"
                onClick={() => setSelectedNews(null)}
                className="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white rounded-2xl text-xs font-black tracking-wide transition-all shadow-md shadow-slate-100 cursor-pointer"
              >
                Fechar Artigo
              </button>
            </div>
